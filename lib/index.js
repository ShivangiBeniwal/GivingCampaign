...
server.post('/api/Notify', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    for (const conversationReference of Object.values(teamsConversationBot_1.ConversationRef)) {
        yield adapter.continueConversation(conversationReference, (turnContext) => __awaiter(void 0, void 0, void 0, function* () {
            yield turnContext.sendActivity({ attachments: [botbuilder_1.CardFactory.adaptiveCard(cardHelper.getCardForMessage(req.body.message))] });
        }));
    }
