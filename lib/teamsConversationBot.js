...
exports.ConversationRef = {};
exports.ConversationDataRef = {};
class TeamsConversationBot extends botbuilder_1.TeamsActivityHandler {
    ...
    addConversationReference(activity) {
        ...
        exports.ConversationRef[conversationReference.conversation.id] = conversationReference;
    }
    // Method to set conversation data reference that has roster information.
    addConversationDataReference(context) {
        return __awaiter(this, void 0, void 0, function* () {
            var members = yield botbuilder_1.TeamsInfo.getMembers(context);
            exports.ConversationDataRef["members"] = members;
        });
    }
